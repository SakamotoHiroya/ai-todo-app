...
func decodeGoogleAuthCallbackResponse(resp *http.Response) (res GoogleAuthCallbackRes, _ error) {
	...
	case 200:
		// Code 200.
		return &GoogleAuthCallbackOK{}, nil
	case 401:
		// Code 401.
...
func decodeStartGoogleAuthResponse(resp *http.Response) (res *StartGoogleAuthFound, _ error) {
	switch resp.StatusCode {
	case 302:
		// Code 302.
		return &StartGoogleAuthFound{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorResponseStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeToggleTaskCompletionResponse(resp *http.Response) (res *Task, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
